...
require (
	...
	github.com/talos-systems/talos/pkg/machinery v0.12.1
...
replace github.com/talos-systems/talos/pkg/machinery => github.com/talos-systems/talos/pkg/machinery v0.12.1
